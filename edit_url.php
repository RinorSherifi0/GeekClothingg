...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query = "UPDATE redirects SET redirect_url='$new_url' WHERE qr_id='$url_id'";
...
<div class="container-box">
  ...
  <form method="POST">
    ...
    <div class="susi-fields-wrapper">
        ...
        <label class="text" for="new_url">QR code's forwarding link</label></center>
       ...
       <input class="text" type="text" id="nfc_url" style="text-align:center;" tabindex="3" autocorrect="off" autocapitalize="none"/>
        ...
        <input type="hidden" name="rd" value="/" />
        <input type="submit" class="button button-primary sign-up-in" value="Edit" tabindex="5" name="login"/>
        <a href="qrcode/qrcode<?php echo $qrcodeid;?>.png" download="qrcode<?php echo $row['qrcode'];?>.png"><button type="button" class="button button-primary sign-up-in" tabindex="5" name="login"/>Download</button></a>

  ...
  <form method="POST">
    ...
    <div class="susi-fields-wrapper">
      <fieldset>
        ...
        <input class="pw text" type="password" name="password" tabindex="4" autocomplete="current-password" autocorrect="off" autocapitalize="none"/>
        <label class="text" for="password2">
          Retype password
        </label>
        <input class="pw text" type="password" name="password2" tabindex="4" autocomplete="current-password2" autocorrect="off" autocapitalize="none"/>
